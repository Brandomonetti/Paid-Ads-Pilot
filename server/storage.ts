...
export class MemStorage implements IStorage {
  ...
  async createKnowledgeBase(insertKnowledgeBase: InsertKnowledgeBase): Promise<KnowledgeBase> {
    ...
    const knowledgeBase: KnowledgeBase = {
      ...
      brandGuidelinesFiles: insertKnowledgeBase.brandGuidelinesFiles || [],
      customerFeedbackFiles: insertKnowledgeBase.customerFeedbackFiles || [],
      marketResearchFiles: insertKnowledgeBase.marketResearchFiles || [],
      competitorAnalysisFiles: insertKnowledgeBase.competitorAnalysisFiles || [],
      competitorAdsFiles: insertKnowledgeBase.competitorAdsFiles || [],
      adDataFiles: insertKnowledgeBase.adDataFiles || [],
      analyticsFiles: insertKnowledgeBase.analyticsFiles || [],
      productPhotosFiles: insertKnowledgeBase.productPhotosFiles || [],
      lifestyleImagesFiles: insertKnowledgeBase.lifestyleImagesFiles || [],
      videoContentFiles: insertKnowledgeBase.videoContentFiles || [],
